   ...
   useEffect(() => {
    ...
    <TableContainer component={Paper}>
        ...
        <TabPanel value={value} index={0}>
            <ProjectTable projects = {projects} sort = "all" sort2 = {sortby}/>
        </TabPanel>
        <TabPanel value={value} index={1}>
            <ProjectTable projects = {projects} sort = "collaborator" sort2 = {sortby}/>
        </TabPanel>
        <TabPanel value={value} index={2}>
            <ProjectTable projects = {projects} sort = "manager" sort2 = {sortby} />
        </TabPanel>
            </TableContainer>
        </div>
    )
